<?php
/**
 * 3 уровень каталога /catalog/brand/model/
 * 
 * @author WPPW
 * @link http://wppw.ru
 * **************************** */
...
if ( $brand = get_term_by( 'slug', $brand, 'product_cat' ) and $model = get_term_by( 'slug', $model, 'product_cat' ) ) {
