...
function ffxf_registering_notice_script() {
	wp_register_script( 'ffxf-rate-sku', plugins_url( '/assets/js/ffxf_rate_sku.js', __FILE__ ), array('jquery'), '1.0.5', true );
	wp_localize_script(
		'ffxf-rate-sku',
		'ffxf_sp',
		array(
...
function ffxf_registering_script() {
	...
	wp_enqueue_style( 'ffxf_autosku', plugins_url( '/assets/css/ffxf_autosku.css', __FILE__ ), array(), '1.0.5' );
	wp_enqueue_style( 'ffxf_tooltip', plugins_url( '/assets/css/ffxf_tooltip.css', __FILE__ ), array(), '1.0.5' );

	if ( 'ffxf_slug' === $skuautoffxf_letters_and_numbers ) {

		$ffxf_slug = get_post_field( 'post_name', get_post() );

		wp_enqueue_script( 'ffxf_slug_script', plugins_url( '/assets/js/ffxf_slug_script.js', __FILE__ ), '1.0.5', true );
		...
		wp_enqueue_script( 'ffxf_auto_sku', plugins_url( '/assets/js/ffxf_auto_sku.js', __FILE__ ), array(), '1.0.5', true );
...
function ffxf_registering_setting_script() {
	if ( isset( $_GET['section'] ) && $_GET['section'] === 'skuautoffxf' ) {
		...
		wp_enqueue_style( 'ffxf_settings', plugins_url( '/assets/css/ffxf_settings.css', __FILE__ ), array(), '1.0.5' );
		wp_enqueue_style( 'ffxf_tooltip', plugins_url( '/assets/css/ffxf_tooltip.css', __FILE__ ), array(), '1.0.5' );

		wp_register_script( 'ffxf_settings_script', plugins_url( '/assets/js/ffxf_settings_script.js', __FILE__ ), array('jquery'), '1.0.5', true );
		wp_localize_script(
