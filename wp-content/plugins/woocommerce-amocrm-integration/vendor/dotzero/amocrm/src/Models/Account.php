...
class Account extends AbstractModel
{
    ...
    public function productCatalogStatus($short = false, $parameters = [])
    {
        $result = $this->getRequest('/api/v2/products_settings', $parameters);

        return $short ? $this->getShorted($result['account']) : $result;
    }
